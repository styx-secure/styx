...
def build_report() -> tuple[dict[str, object], bool]:
    ...
    report: dict[str, object] = {
        ...
        "non_claims": [
            ...
            "A party that withholds a transcript also named by symbolic checkpoint evidence can force whole-projection STALE_EVIDENCE without possessing signing-key material.",
            ...
            "Before a replica receives the second fork sibling it can expose reversible AP authority that becomes permanently empty when the fork arrives; no pre-fork observation is final or safe for irreversible effects.",
