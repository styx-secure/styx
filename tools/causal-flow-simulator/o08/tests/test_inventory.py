...
class InventoryTests(unittest.TestCase):
    def test_closed_inventory_counts(self):
        ...
        self.assertEqual((len(registry.dimensions), len(registry.anchors)), (69, 28))
        self.assertEqual((len(registry.entry_dimensions), len(registry.non_entry_dimensions)), (53, 16))
