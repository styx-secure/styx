...
pre/post state digests proving that failure preserves authoritative state. The
Node oracle is dependency-independent. The
final gate regenerates all nine report families in two distinct clean checkouts
and requires pairwise byte equality plus a trusted Base scope-guard result.
