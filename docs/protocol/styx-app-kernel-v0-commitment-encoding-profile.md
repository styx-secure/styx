...
- **O-08:** the conservative transcript-only envelope selects supported maxima,
...
gates any normative corpus file; O-07 and O-08 are bounded `DECIDED`, while O-10 remains open. O-14 is
