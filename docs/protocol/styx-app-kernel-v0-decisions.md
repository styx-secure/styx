...
- **Rule:** this registry and future specification text remain under the
  repository `AGPL-3.0-or-later` default. Issues #41, #253 and #291 approve
  exactly eighteen Apache-2.0 paths: six existing synthetic interoperability
  vectors, six C0.3 data files whose ordered inventory has SHA-256
  `060212f77405f02c186b27b5925d74b9fbf75f0347807b34dbdb93e6d06a01aa`,
  and six SS-0 data files whose ordered inventory has SHA-256
  `61bea8adc1e36af3bc011df2553f634f0eeeae2c2dba01611a426628341b1861`.
  Issue #293 populates those SS-0 paths only with fully synthetic
  Styx-generated bytes and bounded conformance evidence; this does not authorize
  an adapter, persistence, SDK, transport, product, demo, deployment or
  sensitive use.
...
- **Residual/reopen condition:** any added, renamed or third-party-derived
  corpus path, or any SS-0 corpus byte outside the exact Issue #293 construction
  contract, requires a new exact inventory, provenance analysis, human
  amendment and independent review.
- **Human ratification:** Issue #291 comment `5484188019` by `maverde73` binds
  the exact SS-0 six-path inventory; Issue #293 comment `5485961310` ratifies
  its synthetic-only population. Issue #253/PR #258 remain the authority for
  C0.3 paths.
