...
- **Decision effect:** C0.2a closes O-09; C0.2b closes O-02/O-03; C0.2c closes
  ...
  and is condition-bearing `DECIDED`; O-07 and O-08 are bounded `DECIDED`; O-10 through O-13 remain
...
| O-08 skew/cardinality/activation bounds | `AP` | `K`, `SS`, `RS`, `TR`, `PV` provide capability/resource envelopes | **Bounded `DECIDED` for transcript-only C0.3:** the conservative envelope selects 46 maxima, five activation inputs and two exact-zero values; eleven post-C0.3 and three evidence-only dimensions remain non-entry. No product/runtime support follows. |
