...
- **Decision effect:** C0.2a closes O-09; C0.2b closes O-02/O-03; C0.2c closes
  ...
  and is condition-bearing `DECIDED`; O-07 is bounded `DECIDED`; O-08 is under
  ratified remediation and new human selection; O-10 through O-13 remain
...
| `OB-K10` | Authenticate the O-04 content descriptor; derive/verify the randomized-opening commitment; keep class, availability, binding, retention and replay readiness distinct; reject content-bearing control events; validate append-only removal structure | Payload/opening, descriptor or retained commitment/removal evidence → typed verification/readiness/pending/quarantine result | O-04 and C0.2k select unchanged-opening rejection across credential/sequence contexts plus content-free credential controls; knowledgeable recomputation remains possible. O-06c bounded evidence passes; O-08 bounds the work while O-10 remains open. |
...
| O-08 skew/cardinality/activation bounds | `AP` | `K`, `SS`, `RS`, `TR`, `PV` provide capability/resource envelopes | **`OPEN` during ratified remediation:** 46 semantic maxima, including exact authority-poset antichain width, four capability minima, one structural exact capability-key declaration and two exact-zero values are candidates; eleven post-C0.3 and five evidence-only dimensions remain non-entry. Exact `B4(P)` is proof evidence rather than a runtime gate. New measurement, ForgeRelay selection and exact-final gates are required. No product/runtime support follows. |
