...
Host measurements are selection evidence, not normative thresholds. Their
results will be recorded only after the selection HEAD is frozen; they neither
claim production performance nor replace the selected capability inputs.
...
families. The 65 entry dimension×stage rows are exhaustive:
`S0=9`, `S1=0`, `S3=21`, `S4=10`, `S5=15`, `S6=10`.
