...
describe('assertMlsStateCompatibility — cases A/C of the policy', () => {
  ...
  test('the exact B1 artifact tuple remains accepted after the B2.1 rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B1_MLS_BUILD_INFO))).not.toThrow();
  });

  test('the exact B2.1 artifact tuple remains accepted after the B2.2 rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B2_1_MLS_BUILD_INFO))).not.toThrow();
  });

  test('the exact B2.2 artifact tuple remains accepted after the B2.7 rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B2_2_MLS_BUILD_INFO))).not.toThrow();
  });

  test('the fixture-proven exact B2.7 artifact tuple remains accepted after B3.1', () => {
  ...
  test('the exact B3.2 artifact tuple remains accepted after the B3.2a rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B3_2_MLS_BUILD_INFO))).not.toThrow();
  });

  test('the exact B3.2a artifact tuple remains accepted after the B3.3a rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B3_2A_MLS_BUILD_INFO))).not.toThrow();
  });

  test('the exact B3.3a artifact tuple remains accepted after the B3.3b-1 rebuild', () => {
    expect(() => assertMlsStateCompatibility(freshEnvelope(B3_3A_MLS_BUILD_INFO))).not.toThrow();
  });
...
describe('build-info anti-drift — constants match the vendored artifact', () => {
  ...
  test('state compatibility is exactly the ordered pre-B1 through B3.3b-1 tuple set', () => {
